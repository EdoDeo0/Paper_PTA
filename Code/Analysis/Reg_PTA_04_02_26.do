...
// Alcuni test
gen test_TEND_WB = TREND_EP_Count - WB_EP_Depth	

corr TREND_EP_Count WB_EP_Depth

corr TREND_EP_Count test_TEND_WB

replace TREND_Hard = 0 if TREND_Hard == .

corr TREND_Hard WB_EP_Depth
