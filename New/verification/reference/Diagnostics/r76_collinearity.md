# R7.6 — Collinearita' EP vs TotalDepth (destinazione-anno, 223 trattati in-sample)

|                         | WB_EP_Depth | TREND_EP_Count |
|-------------------------|------------:|---------------:|
| corr grezza con TD      | 0.879        | 0.498           |
| corr within (FE c+t)    | 0.948        | 0.848           |
| VIF (da regressione su TD) | 4.39     | 1.33           |
