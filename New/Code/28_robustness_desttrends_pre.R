...
run_all <- function(cache_fst, green_file, dirty_file, depth_file, depth_var, depth_drop_unmeasured) {
  library(fst)
  library(fixest)
  library(data.table)
...
print(res)
fwrite(res, out_path(here("New/Output/TripleDiff/Tables/r79c_pretrends.csv")))
