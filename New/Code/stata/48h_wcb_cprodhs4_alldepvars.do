************************************************************
*** 48h — C-prod-HS4 subsample: coefficienti + WCB per qua e UV
*** Full panel con filtro prodHS4, FE fpd+fdt+pt
*** Supporta entrambi i depth (totaldepth / desta) via PTA_DEPTH
************************************************************
* OUTPUT: New/Output/TripleDiff/Tables_Stata/cprodhs4_alldepvars{OUTSFX}.csv
...
cap log close _all
log using "$ROOT/New/Output/Diagnostics/stata_logs/48h_cprodhs4_alldepvars$OUTSFX.log", replace text

global CSV_OUT "$ROOT/New/Output/TripleDiff/Tables_Stata/cprodhs4_alldepvars$OUTSFX.csv"
...
* Esecuzione
************************************************************
di as result _n "*** 48h — C-prod-HS4: quantity + unit value ***"
di as result "*** Depth: $PTA_DEPTH | Sample: $PTA_SAMPLE ***"

cprodhs4_one_outcome exp_qua  ln_export_qua
cprodhs4_one_outcome uv_exp   ln_export_value
