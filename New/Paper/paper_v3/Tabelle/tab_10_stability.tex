...
\item \emph{Notes:} Variante baseline, dati a livello di transazione, effetti fissi come nella Tabella \ref{tab:main-full}; errori raggruppati per destinazione.
