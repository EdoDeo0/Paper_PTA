...
was produced twice: in \textsc{Stata} (\texttt{reghdfe}, \citealp{correia2017};
\texttt{boottest}, \citealp{roodman2019}; \texttt{ppmlhdfe}, \citealp{correia2020};
\texttt{eventstudyinteract}, \citealp{sun2021}) and in \textsc{R} (\texttt{fixest},
