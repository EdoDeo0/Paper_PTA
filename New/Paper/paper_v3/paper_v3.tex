...
%   morin2017 -> 2017, correia2017 -> reghdfe WP, inline citations converted);
...
40 control destinations (approximately 14.0 million observations before singleton removal; 13,728,510 after iterative removal of singletons) and addresses the concern that
...
treated destinations, 27.8\% of placebo draws produce a coefficient as large in absolute
...
battery --- survives the wild cluster bootstrap ($p = 0.015$). This should not be taken at face
...
sectors. A continuous intensity measure might tell a different story. We construct one
