...
\item \emph{Notes:} Estimation sample: collapsed panel, excl.\ HK/Macao variant. Standard deviation of regressors computed on the effective sample and weighted. Bootstrap intervals from the \textsc{Stata} implementation.
