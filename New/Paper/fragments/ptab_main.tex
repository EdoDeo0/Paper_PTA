...
\quad wild cluster bootstrap $p$ & 0.65 & 0.07 & 0.39 & 0.86 \\
\quad bootstrap 95\% CI & $[-0.018,$  & $[-0.018,$  & $[-0.0017,$  & $[-0.0031,$  \\
 & $+0.032]$ & $+0.002]$ & $+0.0071]$ & $+0.0056]$ \\
...
fixed-effect singleton removal), FE $pd+dt+pt$, weighted, 228 clusters. All specifications include TotalDepth$\times$green/dirty controls. Wild
