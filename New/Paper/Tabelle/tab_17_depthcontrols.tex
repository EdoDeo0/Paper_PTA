...
(a) Baseline: controllo TotalDepth & -0.00457 & -0.01187$^{***}$ \\
 ...
 & [0.512] & [$<$0.001] \\
\addlinespace
(b) Senza alcun controllo di profondit\`a & -0.00573$^{*}$ & -0.00368 \\
 & (0.00310) & (0.00254) \\
 & [0.065] & [0.149] \\
\addlinespace
(c) Controllo mirato alle sole aree rilevanti & -0.00326 & -0.01212$^{***}$ \\
 & (0.00794) & (0.00352) \\
 & [0.682] & [$<$0.001] \\
\addlinespace
(d) Quota ambientale sul totale, solo trattati & -2.25306$^{*}$ & -1.59582 \\
 & (1.14813) & (1.55170) \\
 & [0.063] & [0.315] \\
\bottomrule
\end{tabular}
