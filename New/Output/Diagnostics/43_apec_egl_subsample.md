...
Colonna `apec_egl` aggiunta a `green_codes_hs1996.csv` (54/247 = 54/247 codici).
...
|---|---:|---:|
| WB x green | -0.0046 (se 0.0070, p=0.513) | 0.0050 (se 0.0127, p=0.693) |
| TREND x green | 0.0018 (se 0.0018, p=0.319) | 0.0032 (se 0.0021, p=0.126) |
